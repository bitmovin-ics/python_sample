...
TEST_ITEM = "dv-with-atmos-ddp-dd-aac"
...
INPUT_PATH_FOR_DOLBY_VISION = "netflix-opencontent/SolLevante/dolbyvision/sollevante_j2k.mxf"
INPUT_PATH_FOR_DOLBY_VISION_METADATA = "netflix-opencontent/SolLevante/dolbyvision/sollevante_j2k_sidecar.xml"
...
def main():
    ...
    encoding = bitmovin_api.encoding.encodings.create(
        encoding=Encoding(
            ...
            cloud_region=CloudRegion.AWS_AP_SOUTHEAST_1,
    ...
    video_ingest_input_stream = bitmovin_api.encoding.encodings.input_streams.dolby_vision.create(
        ...
        dolby_vision_input_stream=DolbyVisionInputStream(
            ...
            metadata_input_path=INPUT_PATH_FOR_DOLBY_VISION_METADATA))
