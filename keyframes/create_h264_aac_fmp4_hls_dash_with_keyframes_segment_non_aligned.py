...
from bitmovin_api_sdk import Keyframe
...
TEST_ITEM = "h264-aac-fmp4-hls-dash-with-keyframes-segment-non-aligned"
...
def main():
    ...
    for profile_h264 in encoding_profiles_h264:
        ...
        h264_codec = bitmovin_api.encoding.configurations.video.h264.create(
            h264_video_configuration=H264VideoConfiguration(
                ...
                rate=fps,
                min_keyframe_interval=key_frame_interval,
                max_keyframe_interval=key_frame_interval,
    ...
    for ad_break in ad_opportunity_placements:
        bitmovin_api.encoding.encodings.keyframes.create(
            encoding_id=encoding.id,
            keyframe=Keyframe(
                time=ad_break,
                segment_cut=True
