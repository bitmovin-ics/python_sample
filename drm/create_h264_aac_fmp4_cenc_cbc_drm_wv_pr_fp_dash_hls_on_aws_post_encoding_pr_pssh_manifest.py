...
TEST_ITEM = "cenc-cbc-drm-wv-pr-fp-dash-hls-aws-pr-pssh"
...
CENC_WIDEVINE_PSSH = 'EhBDIUMhQyFDIUMhQyFDIUMhSPPGiZsG'
CENC_PLAYREADY_PSSH = (
    'RgIAAAEAAQA8AjwAVwBSAE0ASABFAEEARABFAFIAIAB4AG0AbABuAHMAPQAiAGgAdAB0AHAAOgAvAC8AcwBjAGgAZQBtAGEAcwAuAG0AaQBjAHIAbwBzAG8AZgB0AC4AYwBvAG0ALwBEAFIATQAvADIAMAAwADcALwAwADMALwBQAGwAYQB5'
    'AFIAZQBhAGQAeQBIAGUAYQBkAGUAcgAiACAAdgBlAHIAcwBpAG8AbgA9ACIANAAuADMALgAwAC4AMAAiAD4APABEAEEAVABBAD4APABQAFIATwBUAEUAQwBUAEkATgBGAE8APgA8AEsASQBEAFMAPgA8AEsASQBEACAAQQBMAEcASQBEAD0A'
    'IgBBAEUAUwBDAEIAQwAiACAAVgBBAEwAVQBFAD0AIgBJAFUATQBoAFEAeQBGAEQASQBVAE4ARABJAFUATQBoAFEAeQBGAEQASQBRAD0APQAiAD4APAAvAEsASQBEAD4APAAvAEsASQBEAFMAPgA8AC8AUABSAE8AVABFAEMAVABJAE4ARgBP'
    'AD4APABMAEEAXwBVAFIATAA+AGgAdAB0AHAAOgAvAC8AcAByAC4AdABlAHMAdAAuAGQAcgBtAC4AYwBvAG0ALwBwAGwAYQB5AHIAZQBhAGQAeQAvAFIAaQBnAGgAdABzAE0AYQBuAGEAZwBlAHIALgBhAHMAbQB4ADwALwBMAEEAXwBVAFIA'
    'TAA+ADwALwBEAEEAVABBAD4APAAvAFcAUgBNAEgARQBBAEQARQBSAD4A'
)
...
encoding_profiles_h264 = [
    {"height": 1080, "bitrate": 2_500_000, "level": None, "mode": StreamMode.STANDARD},
    {"height": 720, "bitrate": 1_200_000, "level": None, "mode": StreamMode.STANDARD},
    {"height": 480, "bitrate": 750_000, "level": None, "mode": StreamMode.STANDARD},
    {"height": 360, "bitrate": 400_000, "level": None, "mode": StreamMode.STANDARD},
    {"height": 240, "bitrate": 150_000, "level": None, "mode": StreamMode.STANDARD}
]
...
def main():
    ...
    for profile_h264 in encoding_profiles_h264:
        ...
        bitmovin_api.encoding.encodings.muxings.fmp4.drm.cenc.create(
            ...
            cenc_drm=CencDrm(
                ...
                play_ready=CencPlayReady(pssh=CENC_PLAYREADY_PSSH),
    ...
    # === Start Encoding, then generate DASH/HLS manifests after it finishes ===
