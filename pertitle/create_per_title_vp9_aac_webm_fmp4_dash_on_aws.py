...
TEST_ITEM = "per-title-vp9-aac-webm-fmp4-dash-aws"
...
def main():
    ...
    for profile_vp9 in encoding_profiles_vp9_pertitle:
        ...
        # WebM container for VP9. {uuid} keeps per-rendition paths unique.
...
def _create_dash_manifest(encoding_id, output, output_path):
    """DASH manifest. Audio is in FMP4 (sidecar), video Per-Title renditions are in WebM.
    Iterates both containers and adds each rendition to the matching adaptation set."""
