...
from bitmovin_api_sdk import DeinterlaceFilter, PictureFieldParity, DeinterlaceMode, DeinterlaceFrameSelectionMode
from bitmovin_api_sdk import DeinterlaceAutoEnable, StreamFilter
...
def main():
    ...
    for profile_h264 in encoding_profiles_h264:
        ...
        stream_filter_list = [StreamFilter(id_=deinterlace_filter.id, position=0)]
        bitmovin_api.encoding.encodings.streams.filters.create(encoding_id=encoding.id,
                                                               stream_id=h264_stream.id,
                                                               stream_filter=stream_filter_list)
